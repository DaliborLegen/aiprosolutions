...
const projects = [
  ...
  },
  {
    id: "009",
    title: "Piran v žepu",
    italic: "Turistična aplikacija za Piran in Portorož",
    desc: "Turistična tržnica za mobilne naprave (iOS in Android): nastanitve, restavracije, izleti in doživetja na enem mestu, z rezervacijami in provizijskim modelom. Vključuje mestni vodič, zemljevid brez povezave, vremenske informacije in podporo za štiri jezike.",
